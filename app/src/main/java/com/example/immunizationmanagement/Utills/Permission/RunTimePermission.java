package com.example.immunizationmanagement.Utills.Permission;
        ...
        for (int code: PERMISSION_ARRAY_REQUEST) {
            if(code == requestCode) {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    runtimePermissionInterface.doTaskAfterPermissionAccepted();
                    return;
                }else{
                    runtimePermissionInterface.doTaskAfterPermissionRejected();
